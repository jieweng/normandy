package com.pearl.normandy.component.advancedPanel {
	...
	public class AdvancedPanel extends Panel{
		...
		public function addListeners():void{
			this.addEventListener(MouseEvent.CLICK, panelClickHandler, false);
...
//				this.parent.setChildIndex(this, this.parent.numChildren - 1);
		...
		public function resizeOverHandler(event:MouseEvent):void {
			this.resizeCur = CursorManager.setCursor(ImageEnum.IMAGECLASS_CURSOR_RESIZE);
		}
