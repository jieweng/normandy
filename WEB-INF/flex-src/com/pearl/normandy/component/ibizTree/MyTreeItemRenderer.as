 ...
 */
public class MyTreeItemRenderer extends UIComponent
	   		      ...
	   		      IFontContextComponent
{
	 ...
	 */
	private var _listData:MyTreeListData;
	...
	{
		_listData = MyTreeListData(value);
	...
	override protected function commitProperties():void
	{
		...
		if (_data != null)
		{
			...
			if((_listData.item as ProjectUserVO).status == Constants.RESOURCE_PROJECT_STATUS_RELEASED){
				label.setColor(0x00FF00);
				label.text = _listData.label + "   " + Constants.RESOURCE_PROJECT_STATUS_RELEASED;
			}else{
