package com.pearl.normandy.commands.task
{
	...
	public class GetTaskTaskGroupCommand implements Command, Responder
	{
        ...
        {           
            ...
            delegate.getTaskTaskGroup(e.project, e.task);          
        }
           
        public function onResult( event : * = null ) : void
        {                 
        	var e:ResultEvent = ResultEvent(event);       
            model.LOCAL_TASK_TASK_GROUPS = e.result as ArrayCollection;
        }
