package com.pearl.normandy.commands.task
{
	...
	public class GetProjectTaskGroupCommand implements Command, Responder
	{
        ...
        {           
            ...
            delegate.getProjectTaskGroup(e.project);          
        }
           
        public function onResult( event : * = null ) : void
        {                 
        	var e:ResultEvent = ResultEvent(event);       
            model.GLOBAL_PROJECT_TASK_GROUPS = e.result as ArrayCollection;
        }
