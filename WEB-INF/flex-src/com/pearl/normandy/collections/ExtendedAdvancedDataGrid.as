package com.pearl.normandy.collections
{
	...
	public class ExtendedAdvancedDataGrid extends GanttDataGrid
	{
		public function ExtendedAdvancedDataGrid()
		{
			super();
			hierarchicalCollectionView = new HierarchicalCollectionViewFixed();
		}
		...
		public function fastCollapseAll():void
	    {
	        if (dataProvider is IHierarchicalCollectionView && iterator)
	        {
	            ...
	            {
	                HierarchicalCollectionViewFixed(collection).fastCloseNode(item);
	            }
    	...
    	{
            HierarchicalCollectionViewFixed(collection).fastOpenNode(item);
    	}
		...
		private function postExpandAllCollectionEvents():void
	    {
	        ...
	        HierarchicalCollectionViewFixed(collection).collectionChangeHandler(ce); 
	    }			
	}
}